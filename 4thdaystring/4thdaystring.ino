...
char INSERT_SQL[] = "UPDATE int_plant SET Moisture_content = '50%',Light_int ='35%' WHERE Serial_no = '1'";

// WiFi card example
char ssid[] = "Myste6i0";         // your SSID
char pass[] = "12345678910ajith";     // your SSID Password
